...
template:`
   ...
   <div [ngSwitch]="true" >
      ...
      <div *ngSwitchCase="catName=='Women'">
         <div  *ngFor="let data of details | slice:6:12; let i = index  ">
            <div class="col-md-12">
                  <img  class="img-responsive col-md-4" src="{{data.url}}" alt="pic">
                  <div class="col-md-8">
                     <p><em><b>Name:   </b></em>{{data.name}}
      ...
      <div *ngSwitchCase="catName=='Kids'">
         <div *ngFor="let data of details | slice:12:16; let i = index  ">
                <div class="col-md-12">
                  <img  class="img-responsive col-md-4" src="{{data.url}}" alt="pic">
                  <div class="col-md-8">
                     <p><em><b>Name:   </b></em>{{data.name}}
...
export class catComponent implements OnInit{
    details=
        [
        {"id":101,"name":"Shirts","cat":"Formals","color":"Black","price":200000,"desc":"The coolest shirts present in market","url":"https://4.imimg.com/data4/AY/NP/MY-27633995/gents-shirts-500x500.jpg"},
        ...
        {"id":103,"name":"Sportswear","cat":"Sports & Active Wear","color":"Black","price":20000,"desc":"The coolest sportswear present in market","url":"https://s-media-cache-ak0.pinimg.com/736x/e3/6b/e6/e36be60a131d33849f686c6094fcd686--mens-sportswear-suit-men.jpg"},
        {"id":104,"name":"footwear","cat":"Men Footwear","color":"Black","price":2000,"desc":"The coolest footwear present in market","url":"http://i.ebayimg.com/images/i/271723310731-0-1/s-l1000.jpg"},
        {"id":105,"name":"Watches","cat":"Men Accesorries","color":"Black","price":200,"desc":"The coolest watch present in market","url":"http://www.greatbusinessresults.co.uk/images/WnnyQgsvDT/mens-leather-black-eliros-chronograph-maurice-lacroix-men-accessories-el1098ss0013111-strap-watch-17JW.jpg"},
        ...
        {"id":107,"name":"western wear","cat":"Western Wear","color":"Black","price":200000,"desc":"The coolest western wear present in market","url":"https://4.imimg.com/data4/JQ/KA/MY-9013556/indo-western-dress-500x500.jpg"},
        {"id":108,"name":"ethnic wear","cat":"Ethnic Wear","color":"Black","price":3000,"desc":"The coolest ethnic wear present in market","url":"https://5.imimg.com/data5/DD/PT/MY-33689127/party-wear-dresses-500x500.jpg"},
        {"id":109,"name":"sport","cat":"Sports & Active Wears","color":"Black","price":20000,"desc":"The coolest sportswear present in market","url":"https://s-media-cache-ak0.pinimg.com/736x/40/7c/d2/407cd29ab2c7a95a375a5bcae1118291--girls-sportswear-nikes-girl.jpg"},
        {"id":110,"name":"women footwear","cat":"Women Footwear","color":"Black","price":2000,"desc":"The coolest footwear present in market","url":"http://www.fashionfist.com/wp-content/uploads/2014/12/Jimmy-Choo-Ladies-Stunning-Bridal-Shoes2015-Girls-Footwear-Fashion-Fist-4.jpg"},
