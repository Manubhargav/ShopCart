...
<label >Name</label></td>
<td class="tooltip">
<input type="text" ngModel #refname formControlName="name" style="text-transform:Capitalize" class="form-control "><span class="tooltiptext">Contain only alphabets</span></td>
</tr>
...
<td>
<select #ref1 (change)="print_state(ref1.value)"  id="country" name ="country" ngModel formControlName="country"  class="form-control"></select>
</td>
</tr>
<tr>
<td>
...
<td>
<select name ="state" id ="state" ngModel formControlName="state"  class="form-control"></select>
</td>
</tr>
<tr>
<td>
