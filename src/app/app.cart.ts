...
<div on-mouseover="compute()" (click)="compute()">
    Following are the items:<h3 *ngFor="let item of cart ;let i=index">{{item.name}} : {{item.price}} <img style="height:25px;padding-left:20px;padding-top:11px;opacity:0.5"src="https://d30y9cdsu7xlg0.cloudfront.net/png/6447-200.png" (click)="remove(i)"></h3>
